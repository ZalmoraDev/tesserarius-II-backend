...
<h1 style="margin-top: 0; padding: 0;">
   <img src="docs/media/logo/logoW.svg" alt="Tesserarius Logo" style="height: 48px; width: auto; vertical-align: middle; margin-bottom: 12px; margin-right: -14px;">
   Tesserarius II (Backend)
</h1>
</div>
...
🛡 Task Manager Webapp backend 🐘Laravel, TS & PostgreSQL
